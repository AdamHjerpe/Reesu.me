...
<div id="pagewrap">
   <div id="content" class="content">
      ...
      <h1>Reesume</h1>
      <img src="http://placeimg.com/600/200/people" alt="">
      <blockquote>Create your own beautiful resume<br />within minutes, for free!</blockquote>
    
  </div><!-- ./ div.content -->

  <aside class="sidebar main-sign-up">
...
<section id="paper">
  ...
  <section id="resume">
    ...
    <?php if (!auth()) { ?>
      ...
      <h3>Recover account</h3><form action="" method="post" class="form">
        <input type="text" name="username" value="" placeholder="Username or Email" required />
        <input type="submit" name="recover" value="Recover" />
      </form>
    <?php } ?>
